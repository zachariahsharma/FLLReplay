...
def Step_counter(robot):
    ...
    LineFollow(120, .5, robot, 1000)
    robot.turn(28)
    robot.straight(110)
    robot.turn(-28)
    motor_d.run_time(-500, 500, then=Stop.COAST, wait=False)
    robot.straight(120)
    wait(1000)
    motor_d.run_time(-200, 9500, then=Stop.COAST, wait=True)
    robot.straight(-200)
    robot.turn(-200)
    LineFollow(100, -.5, robot, 400)
    robot.stop()
    robot.settings(1000, 1000, 1560, 1560)
    robot.turn(-10)
    robot.straight(1000)
    return
    dead_stop()
